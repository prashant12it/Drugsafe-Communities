        ...
        <div id="page_content" class="row">
            <div class="col-md-12">
                ...
                <div class="portlet light bordered about-text" id="user_info">
                    ...
                    if (in_array(1, $DrugtestidArr) || in_array(2, $DrugtestidArr) || in_array(3, $DrugtestidArr) || in_array(4, $DrugtestidArr) || in_array(4, $DrugtestidArr)) {
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                if (in_array(5, $DrugtestidArr)) {
                                    ...
                                    <!--<div class="row">
                                        <div class="col-sm-8 text-info bold">
                                            <lable>Other Drug <b>"<?php /*echo $sosData[0]['other_drug_test'];*/?>"</b>:</lable>
                                        </div>
                                        <div class="col-sm-2">
                                            <p>$<?php
/*                                                echo number_format($otherRRPVal, 2, '.', ',');*/?></p>
                                        </div>
                                    </div>-->
                                <?php }
                                ?>
